...
module.exports.aliasConfig = {
    ...
    alias : {
        ...
        stripe: path.resolve(
            process.cwd(), // eslint-disable-next-line max-len
            './link_stripe/cartridges/app_stripe_sfra/cartridge/client/default/'
        ),
        paypal: path.resolve(
            process.cwd(), // eslint-disable-next-line max-len
            './link_paypal/cartridges/int_paypal/cartridge/client/default/'
        )   
    },
    extraAliases : {
...
module.exports.sites = [
    {
        ...
        cartridges: [
            './wgaca_stripe_sfra/cartridges/wgaca_stripe_sfra',
            ...
            './link_stripe/cartridges/app_stripe_sfra',
            './link_paypal/cartridges/int_paypal',
        ]
    }
];
