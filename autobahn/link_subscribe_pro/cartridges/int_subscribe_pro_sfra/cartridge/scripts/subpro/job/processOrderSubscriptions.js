    ...
    while (ordersToProcess.hasNext()) {
        ...
        try {
            ...
            if (customerSubproID === null) {
                logError('Could not get customer Subscribe Pro ID. Skipping this order: ' + currentOrderNo);
                continue; // eslint-disable-line no-continue
            }
             ...
             */
            if (!paymentProfileID) {
                logError('Could not get Subscribe Pro Payment profile ID. Skipping order: ' + currentOrderNo);
                continue; // eslint-disable-line no-continue
            }
