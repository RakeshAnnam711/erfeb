...
describe('DefaultPrice model', function () {
    ...
    var DefaultPrice = proxyquire('../../../../../cartridges/int_globale_sfra/cartridge/models/price/default.js', {
    ...
    it('should set property values to "N/A" if price is not available', function () {
