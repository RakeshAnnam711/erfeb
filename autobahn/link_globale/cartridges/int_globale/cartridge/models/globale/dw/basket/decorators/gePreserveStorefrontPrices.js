 ...
 */
function gePreserveStorefrontPrices() {
    ...
    collections.forEach(this.getAllProductLineItems(), function (productLineItem) {
        ...
        productLineItem.custom[globaleHelpers.customAttr.productLineItem.geInternationalPrice] = productLineItem.price.value;
...
module.exports = function (object) {
    Object.defineProperty(object, 'gePreserveStorefrontPrices', {
        value: gePreserveStorefrontPrices
    });
};
