    ...
    Object.defineProperties(object, {
        getPercentagePrice: {
            value: function () {
                ...
                var discountPercentage = this.priceAdjustment.appliedDiscount.percentage;
                ...
                for (var i = 0; i < this.priceAdjustment.appliedDiscount.quantity; i++) {
                    ...
                    var adjustmentItemPrice = pliProrationDataItem.proratedPrice.subtractPercent(100 - discountPercentage);
                    pliProrationDataItem.adjustments.push({ type: Discount.TYPE_PERCENTAGE, price: adjustmentItemPrice });
