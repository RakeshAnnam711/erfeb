...
/**
 * Represents SessionBridgeStrategy
 * @constructor
 * @param {string} basketId - basket id
 * @param {string} token - token
 * @param {Object} jsonPayload - JSON Payload
 */
function SessionBridgeStrategy(basketId, token, jsonPayload) {
    ...
    this.service = geServiceMgr.getOcapiSessionBridgeService(this.token);
}

/* Inherits AbstarctField */
SessionBridgeStrategy.prototype = Object.create(AbstractStrategy.prototype);
 ...
 * @throws {Error}
 */
SessionBridgeStrategy.prototype.apply = function (couponCode) {
 ...
 * @throws {Error}
 */
SessionBridgeStrategy.prototype.remove = function (couponCode) {
    var globaleHelpers = require('*/cartridge/scripts/helpers/globaleHelpers');
    var globaleHooksHelper = require('*/cartridge/scripts/helpers/globaleHooksHelper');
    var globaleCAPIHelpers = require('*/cartridge/scripts/helpers/globaleCAPIHelpers');
    var arrayUtils = require('*/cartridge/scripts/util/globale/array');
...
module.exports = SessionBridgeStrategy;
