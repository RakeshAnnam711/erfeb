...
/**
 * Represents OrderSendToMerchantMixedOrdersResponse
 * @constructor
 */
function OrderSendToMerchantMixedOrdersResponse() {
...
OrderSendToMerchantMixedOrdersResponse.prototype = Object.create(AbstractResponse.prototype);
 ...
 * @returns {void}
 */
OrderSendToMerchantMixedOrdersResponse.prototype.setMainOrderData = function (order, orderData) {
    if (order) {
    ...
    this.errorDescription = orderData.getExecutionNotes() || null;
 ...
 * @returns {void}
 */
OrderSendToMerchantMixedOrdersResponse.prototype.setSubOrderData = function (order, orderData) {
    if (order) {
        this.data.orders.push(order);
    }
    ...
    this.subOrders.push({
        ...
        errorDescription: orderData.getExecutionNotes() || null
    });
};
 ...
 */
OrderSendToMerchantMixedOrdersResponse.prototype.getPayload = function () {
    // response object
    var responseObj = {
...
module.exports = OrderSendToMerchantMixedOrdersResponse;
