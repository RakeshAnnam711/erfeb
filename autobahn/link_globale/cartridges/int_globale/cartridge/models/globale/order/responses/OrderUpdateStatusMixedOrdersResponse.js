...
/**
 * Represents OrderUpdateStatusMixedOrdersResponse
 * @constructor
 */
function OrderUpdateStatusMixedOrdersResponse() {
...
OrderUpdateStatusMixedOrdersResponse.prototype = Object.create(AbstractResponse.prototype);
 ...
 * @returns {void}
 */
OrderUpdateStatusMixedOrdersResponse.prototype.setMainOrderData = function (order, orderData) {
    if (order) {
 ...
 * @returns {void}
 */
OrderUpdateStatusMixedOrdersResponse.prototype.setSubOrderData = function (order, orderData) {
    if (order) {
        this.data.orders.push(order);
    }
 ...
 */
OrderUpdateStatusMixedOrdersResponse.prototype.getPayload = function () {
    // response object
    var responseObj = {
...
module.exports = OrderUpdateStatusMixedOrdersResponse;
