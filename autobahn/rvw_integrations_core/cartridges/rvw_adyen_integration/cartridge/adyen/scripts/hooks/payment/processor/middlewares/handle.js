...
// AB Duplicate file: minor file change to prevent removing all payment methods
...
function removeAllPaymentInstruments(currentBasket) {
  collections.forEach(currentBasket.getPaymentInstruments(), function (item) {
    // AUTOBAHN CORRECTION for saving GC application
    if (!item.paymentMethod.equals(PaymentInstrument.METHOD_GIFT_CERTIFICATE)) {
