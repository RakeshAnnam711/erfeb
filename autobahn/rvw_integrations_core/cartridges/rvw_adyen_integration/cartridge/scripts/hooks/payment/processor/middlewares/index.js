...
var authorize = require('*/cartridge/scripts/hooks/payment/processor/middlewares/authorize').authorize;
...
var processForm = require('*/cartridge/scripts/hooks/payment/processor/middlewares/processForm').processForm;
