...
var integrationsPLIPrefs = require('*/cartridge/models/productLineItem/decorators/integrationProductLineItemPreferences');
...
module.exports = function productLineItem(product, apiProduct, options) {
    ...
    integrationsPLIPrefs(product, apiProduct, options);
    return product;
};
