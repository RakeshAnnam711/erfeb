 ...
 */
function addInventoryList(currentStores, apiStores) {
 ...
 */
// function stores(storesResultsObject, searchKey, searchRadius, storesType, actionUrl, apiKey) {
function stores(storesResultsObject, searchKey, searchRadius, storesType, actionUrl, apiKey, showMap) {
    base.call(this, storesResultsObject, searchKey, searchRadius, storesType, actionUrl, apiKey, showMap);
    this.stores = addInventoryList(this.stores, storesResultsObject);
}
