...
var integrationProductPrefs = require('*/cartridge/models/product/decorators/integrationProductPreferences');
/**
...
module.exports = function fullProduct(product, apiProduct, options) {
    ...
    integrationProductPrefs(product, apiProduct, options);
