...
if (toggleObject.cybersourceCartridgeEnabled) {
    var init = {
        ...
        initConfig: function () {
            ...
            var config = {
                ...
                validate: function (actions) {
                    // AUTOBAHN MOD Just let base form validation run for checkout
        ...
        initPayPalButtons: function () {
            ...
            if (isPaypalEnabled && $('.paypal-button-container-cart1').length > 0) {
                ...
                $('body').trigger('PaymentMethodObserver:iframePresent'); //AUTOBAHN MOD for listener framework
            }
    ...
    var paypalvalidator = {
        // Unneeded as were letting base form validation run instead
