...
server.get('Show', cache.applyPromotionSensitiveCache, function (req, res, next) {
    ...
    try {
        ...
        // AUTOBAHN CUSTOMIZATION Following Logger update to allow debugging against logs with any ProductFactory errors
        require('dw/system/Logger').warn('Tile-Show error: {0}. javaMessage: {1}. fileName: {2}. lineNumber: {3}. stack: {4}', e.toString(), e.javaMessage, e.fileName, e.lineNumber, e.stack);
