...
server.get(
    ...
    function (req, res, next) {
        ...
        // AUTOBAHN MODIFICATION graceful failure is the orderID parameter value should not be accessible to current user
        // var currentCustomerNo = order.customer.profile.customerNo;
        var currentCustomerNo = order.customer && order.customer.profile && order.customer.profile.customerNo;
        var breadcrumbs = [
            {
                htmlValue: Resource.msg('global.home', 'common', null),
                url: URLUtils.home().toString()
