...
function search(req, res) {
    ...
    apiProductSearch = exports.setupSearch(apiProductSearch, req.querystring, req.httpParameterMap); // AUTOBAHN MOD use extensible method
    apiProductSearch.search();

    if (!apiProductSearch.personalizedSort) {
        exports.applyCache(res); // AUTOBAHN MOD use extensible method
    }
    categoryTemplate = exports.getCategoryTemplate(apiProductSearch); // AUTOBAHN MOD use extensible method
