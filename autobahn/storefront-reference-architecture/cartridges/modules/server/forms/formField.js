...
function formField(field) {
    ...
    // AUTOBAHN MOD docs say "We recommend that you add the script to the storefront-reference-architecture repository’s modules folder."
    Object.defineProperty(result, 'attributesNoPattern', {
        get: function () {
            var attributes = '';
            attributes += 'name="' + result.htmlName + '"';
            if (result.mandatory) {
