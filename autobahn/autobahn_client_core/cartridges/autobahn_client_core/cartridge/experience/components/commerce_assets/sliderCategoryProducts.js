...
module.exports.render = function (context, modelIn) {
    ...
    model.display = {
        swatches: context.content.displaySwatches,
        ratings: context.content.displayRatings,
        showQuickView: context.content.displayQuickview,
    };

    model.productsToDisplay = context.content.products_to_display ? context.content.products_to_display : 0;

    model.categoryID = context.content.category ? context.content.category.ID : '';
    ...
    return new Template('experience/components/commerce_assets/sliderCategoryProducts').render(model).text;
};
