...
function handleShippingOptionChange(_x8, _x9, _x0) {
...
function getPaypalButtonConfig(paypalConfig) {
  ...
  return _objectSpread(_objectSpread({
    ...
    onShopperDetails: function () {
      ...
      function onShopperDetails(_x11, _x12, _x13) {
    ...
    onShippingAddressChange: function () {
      ...
      function onShippingAddressChange(_x14, _x15, _x16) {
    ...
    onShippingOptionsChange: function () {
      ...
      function onShippingOptionsChange(_x17, _x18, _x19) {
...
function _init() {
  _init = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee0(paymentMethodsResponse) {
