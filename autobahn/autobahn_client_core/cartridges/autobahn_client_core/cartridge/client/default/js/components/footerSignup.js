...
function removeRenderedNullText(rootNode) {
...
function initializeGlobalNullCleanup() {
    removeRenderedNullText(document.body);

    if (window.jQuery) {
        window.jQuery(document).on('checkout:updateCheckoutView', function () {
            removeRenderedNullText(document.body);
        });
    }
}
