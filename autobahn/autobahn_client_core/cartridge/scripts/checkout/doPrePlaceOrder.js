 ...
 * Live selling line items are always non returnable.
                ...
                .forEach(function(lineItem) {
                    try {
                        ...
                        if (!empty(product) && product.custom) {
                            // live selling line items are never returnable, whatever the product says
                            lineItem.custom.somCC_returnable = !(product.custom.final_sale || lineItem.custom.isLiveSellingLineItem);
                        }
                    } catch(err) {
