...
module.exports.render = function (context, modelIn) {
    ...
    var sixColumnsOnMobile = false;
    switch(content.mobileColumns) {
        case '6 rows, 1 column':
            sharedColumnClass += ' col-12 col-md-2';
            break;
        case '3 rows, 2 columns':
            twoColumnsOnMobile = true;
            sharedColumnClass += ' col-6 col-md-2';
            break;
        case '2 rows, 3 columns':
            threeColumnsOnMobile = true;
            sharedColumnClass += ' col-4 col-md-2';
            break;
        case '1 row, 6 columns':
            sixColumnsOnMobile = true;
            sharedColumnClass += ' col-2';
            break;
        default: // 2 rows, 3 columns
            sharedColumnClass += ' col-4 col-md-2';
    }
    ...
    if (content.noPaddingCol) {
        if (twoColumnsOnMobile) {
            column1Class += ' pr-0';
            column2Class += ' pl-0 px-md-0';
            column3Class += ' pr-0 px-md-0 mt-0';
            column4Class += ' pl-0 px-md-0 mt-0';
            column5Class += ' pr-0 px-md-0 mt-0';
            column6Class += ' pl-0 mt-0';
        } else if (threeColumnsOnMobile) {
            column1Class += ' pr-0';
            column2Class += ' px-0';
            column3Class += ' pl-0 px-md-0';
            column4Class += ' pr-0 px-md-0 mt-0';
            column5Class += ' px-0 mt-0';
            column6Class += ' pl-0 mt-0';
        } else if (sixColumnsOnMobile) {
            column1Class += ' pr-0';
            column2Class += ' px-0';
            column3Class += ' px-0';
            column4Class += ' px-0';
            ...
            column3Class += ' px-md-0 mt-0';
            column4Class += ' px-md-0 mt-0';
            column5Class += ' px-md-0 mt-0';
            column6Class += ' pl-md-0 mt-0';
        }
    }
    ...
    model.column4Class = sharedColumnClass + column4Class;
    model.column5Class = sharedColumnClass + column5Class;
    model.column6Class = sharedColumnClass + column6Class;
    ...
    model.col4AnimationDelay = content.col4AnimationDelay || SiteConstants.ComponentAnimationDelay;
    model.col5AnimationDelay = content.col5AnimationDelay || SiteConstants.ComponentAnimationDelay;
    model.col6AnimationDelay = content.col6AnimationDelay || SiteConstants.ComponentAnimationDelay;
    ...
    return new Template('experience/components/commerce_layouts/6column').render(model).text;
};
