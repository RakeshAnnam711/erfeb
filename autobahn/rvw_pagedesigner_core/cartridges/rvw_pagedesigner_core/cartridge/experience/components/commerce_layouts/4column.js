...
/**
 * Render logic for the storefront. Variable rows and columns (Mobile) 1 Row x 4 Col (Desktop) layout
...
module.exports.render = function (context, modelIn) {
    ...
    var fourColumnsOnMobile = false;
    if (content.mobileColumns === '4 rows, 1 column') {
        sharedColumnClass += ' col-12 col-md-3';
        // WGACA MODIFICATION - Additional SM class
        sharedColumnClass += ' col-sm-6';
    } else if (content.mobileColumns === '1 row, 4 columns') {
        fourColumnsOnMobile = true;
        sharedColumnClass += ' col-3';
    } else {
        twoColumnsOnMobile = true;
        sharedColumnClass += ' col-6 col-md-3';
    }
    ...
    if (content.noPaddingCol) {
        if (twoColumnsOnMobile) {
            ...
            column4Class += ' pl-0 mt-0';
        } else if (fourColumnsOnMobile) {
            column1Class += ' pr-0';
            column2Class += ' px-0';
            column3Class += ' px-0';
            column4Class += ' pl-0';
    ...
    return new Template('experience/components/commerce_layouts/4column').render(model).text;
};
