...
module.exports.render = function (context, modelIn) {
    ...
    model.embeddedComponentContainerClass = content.embeddedComponentContainerClass || '';
    ...
    if (content.backgroundImageMobile) {
        model.backgroundImageMobile = {
            alt: content.backgroundImageMobile.file.getAlt() || '',
            focalPointX: (content.backgroundImageMobile.focalPoint.x * 100) + '%',
            focalPointY: (content.backgroundImageMobile.focalPoint.y * 100) + '%',
            src: {
                mobile: ImageTransformation.url(content.backgroundImageMobile, { device: 'mobile' }),
                mobile2x: ImageTransformation.url(content.backgroundImageMobile, { device: 'mobile2x' })
            }
        };
    }
    ...
    if (model.backgroundLink) {
        ...
        model.contentStack += ' has-background-link';
    }
