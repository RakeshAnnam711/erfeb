/******/ (() => { // webpackBootstrap
/*!*****************************************************************!*\
  !*** ./cartridges/bm_paypal/cartridge/client/default/js/tab.js ***!
  \*****************************************************************/
/*!
...
(function () {
   ...
   */
  const dataBsToggle = 'data-toggle';
   ...
   */
  const dataBsTarget = 'data-target';

  /**
   * Global namespace for most components `parent` option.
   */
  const dataBsParent = 'data-parent';

  /**
   * Global namespace for most components `container` option.
   */
  const dataBsContainer = 'data-container';

  /**
   * Returns the `Element` that THIS one targets
   * via `data-target`, `href`, `data-parent` or `data-container`.
   *
  ...
  class Tab extends BaseComponent {
    ...
    show() {
      ...
      if (!(nav && Timer.get(nav)) && !hasClass(element, activeClass)) {
        ...
        /* istanbul ignore else */
        if (nav) {
            tabPrivate.set(nav, { tab, content });
        }
  ...
  document.addEventListener('DOMContentLoaded', () => {
    Array.from(document.querySelectorAll('[data-toggle="tab"]')).map((element) => new Tab(`#${element.id}`));

    const tabName = (new URLSearchParams(location.search)).get('tab');
    const tabItem = document.getElementById(`${tabName}-tab`);
