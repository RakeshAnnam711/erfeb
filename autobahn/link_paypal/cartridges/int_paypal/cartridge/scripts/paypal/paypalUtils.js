...
function createAccountSDKUrl() {
    const clientID = getClientId();
    let sdkUrl = 'https://www.paypal.com/sdk/js?client-id=' + clientID + '&commit=false&vault=true&disable-funding=card';
...
function getUrls() {
    ...
    return {
        ...
        paymentStage: URLUtils.https('Checkout-Begin', 'stage', 'payment-PayPal').toString(),
