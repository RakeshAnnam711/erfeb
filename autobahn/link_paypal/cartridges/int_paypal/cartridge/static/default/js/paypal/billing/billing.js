...
/******/ 	return __webpack_require__(__webpack_require__.s = "../link_paypal/cartridges/int_paypal/cartridge/client/default/js/paypal/billing/billing.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "../link_paypal/cartridges/int_paypal/cartridge/client/default/js/paypal/billing/billing.js":
/*!**************************************************************************************************!*\
  !*** ../link_paypal/cartridges/int_paypal/cartridge/client/default/js/paypal/billing/billing.js ***!
  \**************************************************************************************************/
/*! no exports provided */
...
/* harmony import */ var _billingHelper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./billingHelper */ "../link_paypal/cartridges/int_paypal/cartridge/client/default/js/paypal/billing/billingHelper.js");
/* harmony import */ var _registered_billingAgreementHelper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./registered/billingAgreementHelper */ "../link_paypal/cartridges/int_paypal/cartridge/client/default/js/paypal/billing/registered/billingAgreementHelper.js");
...
if (window.paypal && (!isBAEnabled || !isRegisteredUser)) {
  sdkLoaded = true;
  ...
  var ppTab = document.querySelector('.nav-item .paypal-tab.active');
  ...
  if (ppTab) {
    ...
    } else if (isRegisteredUser && isBAEnabled) {
      Object(_registered_billingAgreementHelper__WEBPACK_IMPORTED_MODULE_3__["toggleBABtnVisibility"])($restPaypalAccountsList);
    }
  }

  if (isRegisteredUser && isBAEnabled) {
    Object(_registered_billingAgreementHelper__WEBPACK_IMPORTED_MODULE_3__["assignEmailForSavedBA"])(isRegisteredUser);
  }
}
...
if ($restPaypalAccountsList) {
  $restPaypalAccountsList.onchange = function (e) {
    ...
    if (!sdkLoaded && Object(_billingHelper__WEBPACK_IMPORTED_MODULE_2__["isNewAccountSelected"])($restPaypalAccountsList)) {
      Object(_billingHelper__WEBPACK_IMPORTED_MODULE_2__["injectSDK"])();
      sdkLoaded = true;
    }
