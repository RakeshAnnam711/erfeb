...
function HandleDAVResponse(ResponseObject) {
    ...
    switch (DAVReasonCode) {
        case 100:
            return { authorized: true, authResponse: ResponseObject };
        case 101:
        case 102:
        case 450:
        case 451:
        ...
        case 459:
        case 460:
            return { declined: true, authResponse: ResponseObject };
        default:
            return { error: true, authResponse: ResponseObject };
    }
}
...
function ProcessCardAuthResponse(serviceResponse, shipTo, billTo) {
    ...
    if (serviceResponse.ccAuthReply !== null) {
        ...
        responseObject.cvCode = serviceResponse.ccAuthReply.cvCode;
    }
...
function HandleCardResponse(ResponseObject) {
    ...
    switch (Number(ResponseObject.ReasonCode)) {
        ...
        case 231:
        case 202:
            return { error: true, declined: true, authResponse: ResponseObject };
        ...
        case 480:
            return { review: true, authResponse: ResponseObject };
    ...
    if (!(CybersourceHelper.getDavEnable() && CybersourceHelper.getDavOnAddressVerificationFailure() === 'REJECT'
        ...
        if (serviceResponse.AVSCode === 'N') {
            ...
            if (CybersourceHelper.getAvsIgnoreResult() === true) {
                return { review: true, authResponse: serviceResponse };
            }
            return { declined: true, authResponse: serviceResponse };
        }
