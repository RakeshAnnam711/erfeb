...
/**
 * AUTOBAHN UPDATE:
 * Copying this file from base to make 2 line changes:
 * var minChars = preferences.minTermLength;
 * var maxSuggestions = preferences.maxSuggestions;
 * These now use custom preferences from rvw_autobahn_core/cartridges/rvw_autobahn_core/cartridge/config/preferences.js
 */
