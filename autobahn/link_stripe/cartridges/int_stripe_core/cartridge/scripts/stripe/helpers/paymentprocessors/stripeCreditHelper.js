...
function Handle(args) {
    ...
    const sourceId = paramsMap.stripe_source_id.stringValue
        || paramsMap.dwfrm_billing_creditCardFields_selectedCardID.stringValue
        || paramsMap.saved_card_id.stringValue
        || paramsMap.selectedCardID.stringValue
        || paramsMap.dwfrm_billing_stripe_source_id.stringValue;
    const cardNumber = paramsMap.stripe_card_number.stringValue;
    const cardHolder = paramsMap.stripe_card_holder.stringValue;
    const cardExpMonth = paramsMap.stripe_card_expiration_month.stringValue;
    const cardExpYear = paramsMap.stripe_card_expiration_year.stringValue;
    const postedCardType = paramsMap.dwfrm_billing_creditCardFields_cardType.stringValue;
        ...
        try {
            ...
            Transaction.wrap(function () {
                ...
                if (charge.balance_transaction) {
                    paymentInstrument.paymentTransaction.transactionID = paymentIntentId;
