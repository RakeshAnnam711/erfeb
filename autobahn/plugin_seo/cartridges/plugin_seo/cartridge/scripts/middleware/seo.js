...
var seoPreferences = require('~/cartridge/config/preferences').seo || {};
...
function addCurrentPageMetaData(req, res, next) {
    ...
    if (!seoPreferences.enablePageMetaData) {
        return next();
    }
 ...
 */
 function addSchemaData(req, res, next) {
    if (!seoPreferences.enableSchema) {
        return next();
    }
 ...
 */
 function ensureProductOfflineRedirection(req, res, next) {
    if (!seoPreferences.enableProductOfflineRedirection || !req.querystring.pid) {
        return next();
    }
 ...
 */
 function ensureCategoryOfflineRedirection(req, res, next) {
    if (!seoPreferences.enableCategoryOfflineRedirection || !req.querystring.cgid) {
        return next();
    }
