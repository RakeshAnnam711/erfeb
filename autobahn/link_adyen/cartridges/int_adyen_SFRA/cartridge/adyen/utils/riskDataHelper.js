...
var __RiskDataHelper = {
  createBasketContentFields: function createBasketContentFields(order) {
    ...
    productLines.forEach(function (item) {
      ...
      basketData["riskdata.basket.item".concat(itemNr, ".sku")] = (item.product && item.product.manufacturerSKU) ? item.product.manufacturerSKU : '';
      basketData["riskdata.basket.item".concat(itemNr, ".brand")] = item.product ? item.product.brand : '';
      basketData["riskdata.basket.item".concat(itemNr, ".manufacturer")] = (item.product && item.product.manufacturerName) ? item.product.manufacturerName : '';
