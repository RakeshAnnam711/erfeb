...
- Local syntax checks passed for both changed files. Full lint/unit test execution was blocked locally because the installed Node version is `v10.24.1`, while the Global-e cartridge requires Node `>=18.19.0`.
